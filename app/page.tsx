...
type GamepassOrder = {
  ...
  gamepass_links: GamepassLink[] | null; buyer_username: string; buyer_source: BuyerSource; status: OrderStatus;
...
type RobuxPayout = {
  id: string; buyer_username: string; buyer_source: BuyerSource; roblox_username: string; robux_amount: number; source_group: SourceGroup;
...
export default function Home() {
  ...
  const [gamepassForm, setGamepassForm] = useState({ buyer_username: "", buyer_source: "telegram" as BuyerSource, robux_amount: "", process_type: "slow" as ProcessType, status: "pending" as OrderStatus, notes: "" });
  const [gamepassLinks, setGamepassLinks] = useState<GamepassLink[]>([{ amount: 0, link: "" }]);
  const [payoutForm, setPayoutForm] = useState({ buyer_username: "", buyer_source: "telegram" as BuyerSource, roblox_username: "", robux_amount: "", source_group: "A (supp)" as SourceGroup, status: "pending" as PayoutStatus, notes: "" });
